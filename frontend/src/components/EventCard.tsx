      ...
      >
        <Card className="w-full border rounded-lg shadow-xs p-4 h-full">
          ...
          <CardContent className="mt-1">
            ...
            <p className="text-sm text-gray-600 mt-1">Total upcoming events</p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      >
        <Card className="w-full border rounded-lg shadow-xs p-4">
          ...
          <CardContent className="mt-1">
            ...
            <p className="text-sm text-gray-600 mt-1">Total scheduled events</p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      >
        <Card className="w-full border rounded-lg shadow-xs p-4">
          ...
          <CardContent className="mt-1">
            ...
            <p className="text-sm text-gray-600 mt-1">Total completed events</p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      >
        <Card className="w-full border rounded-lg shadow-xs p-4">
          ...
          <CardContent className="mt-1">
            ...
            <p className="text-sm text-gray-600 mt-1">Total number of events</p>
          </CardContent>
        </Card>
      </motion.div>
    </div>
